...
const [urls ,setUrls] = useState(`https://api.thecatapi.com/v1/images/search?limit=10&order=Desc`);




const handleUrls =(e)=>{
    localStorage.setItem('urls',`https://api.thecatapi.com/v1/images/search?${e}&limit=10&order=Desc`);
    setUrls(urls);
    //console.log(urls);
};
